		...
		try {
			...
			{ // User hit cancel
				...
				if(panel.numCharts == 1) {
					data.add(new ExportData(panel.createChart(panel.view[0],0), "Graph", "Data Filter:\n" + panel.view[0]));
				}
				else if(panel.numCharts == 2) {
					data.add(new ExportData(panel.createChart(panel.view[1],1), "Graph 1", "Data Filter:\n" + panel.view[1]));
					data.add(new ExportData(panel.createChart(panel.view[2],2), "Graph 2", "Data Filter:\n" + panel.view[2]));
				}
